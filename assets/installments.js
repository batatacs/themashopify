document.addEventListener("DOMContentLoaded", function() {
  ...
  function renderInstallments() {
    ...
    priceElements.forEach(function(el) {
      ...
      // Procura o container de preço/produto mais próximo para limitar a busca. Adicionados mais seletores para maior compatibilidade.
      var priceWrapper = el.closest('.product-info, .price, .price-container, .product-price, .product__price, [data-price-wrapper], .product-single__meta, .detail-price, .grid-view-item, .product-card, .product-item, .product-block, .product-card__info, .product-item-info, .product-card__content');

      if (priceWrapper) {
        // Procura por elementos de preço de comparação DENTRO do wrapper.
        // Adicionados mais seletores como .old-price, .price--was, .price--line-through para maior compatibilidade.
