...
(function($) {
    ...
    $.fn.countdown = function(options) {
        var defaults = {
            until: '',
            layout: '<span class="box-count day"><span class="number">0</span><span class="text">Dias</span></span><span class="box-count hrs"><span class="number">0</span><span class="text">Hrs</span></span><span class="box-count min"><span class="number">0</span><span class="text">Min</span></span><span class="box-count secs"><span class="number">0</span> <span class="text">Seg</span></span>',
            leadingZero: true,
            countStepper: -1, // s: -1 // min: -60 // hour: -3600
            timeout: '<span class="timeout">Tempo esgotado!</span>',
        };
